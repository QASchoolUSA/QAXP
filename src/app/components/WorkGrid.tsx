      ...
      {projects.map((project) => (
        <StaggerItem key={project.url}>
          <motion.a
            ...
            className="group glass-card flex h-full flex-col overflow-hidden rounded-2xl cursor-pointer"
          ...
          >
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${project.accent}22 0%, #fafafa 55%, ${project.accent}11 100%)`,
              }}
            >
              <div
              ...
              <div className="absolute bottom-4 left-4 right-4 flex flex-wrap gap-2">
                {project.tags?.slice(0, 3).map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-white/60 bg-white/80 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide text-zinc-700 backdrop-blur-sm"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="flex flex-1 flex-col p-5">
              ...
              <h3 className="mt-2 font-heading text-lg font-semibold text-zinc-900 transition-colors duration-200 group-hover:text-[#2563EB]">
                {project.title}
              </h3>
              ...
              <div className="mt-4 flex items-center justify-between border-t border-zinc-200/80 pt-4">
                ...
                <span className="flex h-9 w-9 items-center justify-center rounded-full bg-zinc-900 text-white group-hover:bg-[#2563EB] transition-colors duration-200">
